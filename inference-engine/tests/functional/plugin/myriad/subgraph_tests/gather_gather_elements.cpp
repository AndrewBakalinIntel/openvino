...
class Gather_GatherElements : public testing::WithParamInterface<std::string>,
    ...
    void SetUp() override {
        ...
        const auto concat1 = std::make_shared<ngraph::opset6::Concat>(
            ngraph::NodeVector{unsqueeze1, unsqueeze2, unsqueeze3, ngraph::opset6::Constant::create(ngraph::element::i32, ngraph::Shape{1}, {64})},
            0);
        const auto concat2 = std::make_shared<ngraph::opset6::Concat>(
            ngraph::NodeVector{unsqueeze4, unsqueeze5, unsqueeze6, ngraph::opset6::Constant::create(ngraph::element::i32, ngraph::Shape{1}, {64})},
            0);
